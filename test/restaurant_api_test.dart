...
import 'package:chiks_restaurant_app/data/api/api_service.dart';
import 'package:chiks_restaurant_app/data/model/restaurant_detail.dart';
import 'package:chiks_restaurant_app/data/model/restaurant.dart';
...
void main() {
  ...
  group('Test Restaurant API', () {
    ...
    test('verify json parsing fetch all restaurant', () async {
      ...
      expect(await apiService.getRestaurant(), isA<RestaurantResult>());
    });
